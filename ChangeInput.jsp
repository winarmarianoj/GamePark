                                ...
                                <div class="col-md-8">
                                  <div class="card">
                                    <div class="card-header card-header-primary">
                                      <h4 class="card-title">Ingresar los datos </h4>
                                    </div>
                                    <div class="card-body">
                                        
                                        <%
                                            Entrada ent = (Entrada) request.getSession().getAttribute("entrada");    
                                        %>
                                            ...
                                            <div class="row my-4"  >
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                      <label class="bmd-label-floating">Datos de la Entrada</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                      <label class="bmd-label-floating">Id de Entrada</label>
                                                      <input type="text" class="form-control" id="idEntrada" name="idEntrada" value="<%=ent.getEntrada_id()%>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                <div class="form-group">
                                                  <label class="bmd-label-floating">Fecha</label>
                                                  <input type="text" class="form-control" id="fechaEntrada" name="fechaEntrada" value="<%=ent.getFecha()%>">
                                                  <p><b>Recuerde Formato de la Fecha debe ser AAAA-MM-DD Gracias.</b></p>
                                                </div>
                                              </div>
                                            </div>                                            
                                            <div class="row my-4">                                                                   
                                              <div class="col-md-4">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" id="idCliEntrada" name="idCliEntrada" value="<%=ent.getCliente().getCliente_id()%>">
                                                </div>
                                              </div>
                                              <div class="col-md-4">
                                                <div class="form-group">
                                                  <label class="bmd-label-floating">Id Empleado</label>
                                                  <input type="text" class="form-control" id="idEmpEntrada" name="idEmpEntrada" value="<%=ent.getEmpleado().getEmpleado_id()%>">
                                                </div>
                                              </div>
                                              <div class="col-md-4">
                                                <div class="form-group">
                                                  <label class="bmd-label-floating">Id Juego</label>
                                                  <input type="text" class="form-control" id="idJueEntrada" name="idJueEntrada" value="<%=ent.getJuego().getJuego_id()%>">
                                                </div>
                                              </div>
                                            </div>
                                          
                                          <!--INICIO DE BOTONES-->
                                          <input type="button" name="Supervisar: Primer Paso" id="changeEntrada" value="Supervisar: Primer Paso" " class="btn btn-warning"/>  
