                      ...
                      <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class=""> <!--card-header card-header-primary-->
                              <h4 class="card-category mt-0"><b>Ingrese el Id del Usuario que desee Modificar</b></h4>
                              
                              <form action="TakeIdUserServlet" method="POST">
                                    <div class="col">                          
                                        <label id="labels">Id del Usuario</label>
                                        <input type="text"  id="idCliente" placeholder="" value="" name="idChangeUsuario" required>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="reportTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <%
                                                List<Usuario> listUser = (List<Usuario>) sesion.getAttribute("listUser");
