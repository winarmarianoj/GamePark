            ...
            <div class="container-fluid dash">
              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <div class="card">
                                    <div class="card-header card-header-primary">
                                      <h4 class="card-title">Cliente a Eliminar</h4>
                                    </div>
                                    <div class="card-body">
                                          ...
                                          <div class="row my-4">
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="idDeleteCliente" name="idDeleteCliente">
                                              </div>                                                
                                            </div>                                                          
                                          </div>                                         
                                          <input type="button" name="Supervisar: Primer Paso" id="deleteCliente" value="Supervisar: Primer Paso" " class="btn btn-warning"/>  
                  ...
                  <section class="columna2 col-12 offset-fixed">
                        ...
                        <!--INICIO DE LA TABLAS CLIENTES -->
                        <div class="col-md-12">
                            <div class="card card-plain">

                             <div class="card-header card-header-primary">
                               <h4 class="card-title mt-0"> Listados de Clientes</h4>                       
                             </div>
                                  ...
                                  <div class="table-responsive">
                                      <table class="table table-hover" id="reportTable">
                                          ...
                                          <tbody>
                                              <tr>
                                                  <%
                                                  List<Cliente> listClient = (List<Cliente>) sesion.getAttribute("cliDeleteList");
