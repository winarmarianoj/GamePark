                                ...
                                <div class="col-md-8">
                                  <div class="card">
                                    <div class="card-header card-header-primary">
                                      <h4 class="card-title">Usuario a Eliminar</h4>
                                    </div>
                                    <div class="card-body">
                                          ...
                                          <div class="row my-4">
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="idDeleteUsuario" name="idDeleteUsuario">
                                              </div>                                                
                                            </div>                                                          
                                          </div>                                         
                                          <input type="button" name="Supervisar: Primer Paso" id="deleteUser" value="Supervisar: Primer Paso" " class="btn btn-warning"/>  
                ...
                <div class="row">                  
                  ...
                  <div class="col-md-12">
                    <div class="card card-plain">
                      ...
                      <div class="card-header card-header-primary">
                        <h4 class="card-title mt-0"> Listados de Usuarios</h4>                       
                      </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="reportTable">
                                ...
                                <tbody>
                                    <tr>
                                        <%	
                                        List<Usuario> listUser = (List<Usuario>) sesion.getAttribute("usuarioDeleteList");
                                        for (Usuario elemento : listUser) { 
                                %>
                                      <td><%=elemento.getUsuario_id()%></td>
