                      ...
                      <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class=""> <!--card-header card-header-primary-->
                              <h4 class="card-category mt-0"><b>Ingrese el Id del Cliente que desee Modificar</b></h4>
                              <form action="TakeIdClientServlet" method="POST">
                                    <div class="col">                          
                                        <label id="labels">Id del Cliente</label>
                                        <input type="text"  id="idCliente" placeholder="" value="" name="idChangeCli" required>
                                    </div>
                                  ...
                                  <div class="table-responsive">
                                      <table class="table table-hover" id="reportTable">
                                          ...
                                          <tbody>
                                              <tr>
                                                  <%
                                                  List<Cliente> listClient = (List<Cliente>) sesion.getAttribute("listClient");
