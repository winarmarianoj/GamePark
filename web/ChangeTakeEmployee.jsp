                      ...
                      <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class=""> <!--card-header card-header-primary-->
                              <h4 class="card-category mt-0"><b>Ingrese el Id del Empleado que desee Modificar</b></h4>
                              
                              <form action="TakeIdEmployeeServlet" method="POST">
                                    <div class="col">                          
                                        <label id="labels">Id del Empleado</label>
                                        <input type="text"  id="idCliente" placeholder="" value="" name="idChangeEmp" required>
                                    </div>
                              ...
                              <div class="table-responsive">
                                  <table class="table table-hover" id="reportTable">
                                      ...
                                      <tbody>
                                          <tr>
                                              <%
                                              List<Empleado> listEmp = (List<Empleado>) sesion.getAttribute("listEmployee");
