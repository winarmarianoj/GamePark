                      ...
                      <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class=""> <!--card-header card-header-primary-->
                              <h4 class="card-category mt-0"><b>Ingrese el Id del Juego que desee Modificar</b></h4>
                              
                              <form action="TakeIdGameServlet" method="POST">
                                    <div class="col">                          
                                        <label id="labels">Id del Juego</label>
                                        <input type="text"  id="idCliente" placeholder="" value="" name="idChangeJuego" required>
                                    </div>
                  ...
                  <section class="columna2 col-12 offset-fixed">
                          ...
                          <div class="col-md-12">
                            <div class="card card-plain">
                              ...
                              <div class="card-header card-header-primary">
                                <h4 class="card-title mt-0"> Listados de Juegos</h4>                       
                              </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="reportTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <%		
                                                List<Juego> listGame = (List<Juego>) sesion.getAttribute("listGame");
                                                for (Juego jue : listGame) { 
                                        %>
                                              <td><%=jue.getJuego_id()%></td>
                                              <td><%=jue.getNombre()%></td>
                                              <td><%=jue.getEdadMinima()%></td>
                                              <td><%=jue.getCapacidad()%></td>
                                              <td><%=jue.getCategoria()%></td>
                                            </tr>
