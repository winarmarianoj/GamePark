                      ...
                      <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class=""> <!--card-header card-header-primary-->
                              <h4 class="card-category mt-0"><b>Ingrese el Id del Horario que desee Modificar</b></h4>
                              
                              <form action="TakeIdHourServlet" method="POST">
                                    <div class="col">                          
                                        <label id="labels">Id del Horario</label>
                                        <input type="text"  id="idCliente" placeholder="" value="" name="idChangeHorario" required>
                                    </div>
                              ...
                              <div class="table-responsive">
                                  <table class="table table-hover" id="reportTable">
                                      ...
                                      <tbody>
                                          <tr>
                                              <%
                                              List<Horario> listHours = (List<Horario>) sesion.getAttribute("listHour");
