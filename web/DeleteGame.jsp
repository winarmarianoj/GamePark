                                ...
                                <div class="col-md-8">
                                  <div class="card">
                                    <div class="card-header card-header-primary">
                                      <h4 class="card-title">Juego a Eliminar</h4>
                                    </div>
                                    <div class="card-body">
                                          ...
                                          <div class="row my-4">
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="idDeleteJuego" name="idDeleteJuego" >
                                              </div>                                                
                                            </div>                                                          
                                          </div>                                         
                                          <input type="button" name="Supervisar: Primer Paso" id="deleteJuego" value="Supervisar: Primer Paso" " class="btn btn-warning"/>  
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="reportTable">
                                ...
                                <tbody>
                                    <tr>
                                        <%
                                        List<Juego> listGame = (List<Juego>) sesion.getAttribute("juegoDeleteList");
