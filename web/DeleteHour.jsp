...
<body>
              ...
              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <div class="card">
                                    <div class="card-header card-header-primary">
                                      <h4 class="card-title">Hora a Eliminar</h4>
                                    </div>
                                    <div class="card-body">

                                        <!--INICIO DEL FORMULARIO -->  
                                        <form action="DeleteHourServlet" method="POST" >                                          
                                          <div class="row my-4">
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                <label class="bmd-label-floating">ID del Hora</label>
                                                <input type="text" class="form-control" id="idDeleteHora" name="idDeleteHora">
                                              </div>                                                
                                            </div>                                                          
                                          </div>                                         
                                          <input type="button" name="Supervisar: Primer Paso" id="deleteHour" value="Supervisar: Primer Paso" " class="btn btn-warning"/>  
                  ...
                  <div class="col-md-12">
                    <div class="card card-plain">
                      ...
                      <div class="card-header card-header-primary">
                        <h4 class="card-title mt-0"> Listados de Horarios</h4>                       
                      </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="reportTable">
                                ...
                                <tbody>
                                    <tr>
                                        <%
                                        List<Horario> listHours = (List<Horario>) sesion.getAttribute("horaDeleteList");
                                        for (Horario hor : listHours) { 
                                %>
                                      <td><%=hor.getHorario_id()%></td>
                                      <td><%=hor.getHora_inicio()%></td>
                                      <td><%=hor.getHora_fin()%></td>
                                    </tr>
    ...
    <script src="js/deleteHour.js"></script>
